...
public class IntArrayWorkerTester
{
  ...
  {  
    ...
    int[][] nums4 = {{1, 2, 3}, {-60, 5, 1}};
    worker.setMatrix(nums4);
    largest = worker.getLargest();
    System.out.println("Largest should be 5 and is " + largest);
    // test when duplicate largest
    int[][] nums5 = {{69, 2, 6}, {4, 5, 1}};
    worker.setMatrix(nums5);
    largest = worker.getLargest();
    System.out.println("Largest should be 69 and is " + largest);
  }
